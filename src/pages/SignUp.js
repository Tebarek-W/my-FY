      ...
      <div className='mx-auto container p-4'>
        ...
        <div className='bg-white p-5 w-full max-w-sm mx-auto'>
         <div className='w-20 h-20 mx-auto relative overflow-hidden rounded-full'>
            ...
            <input type='file' className='hidden' onChange={handleUplaodPic}/>
              </label>
            </form>
         </div>
         ...
         <div className='grid'>
          ...
          <button className='bg-red-600 hover:bg-red-700 px-6 py-2 text-white rounded-full w-full max-w-[150px] hover:scale-110 transition-all mx-auto block mt-6'>Sign up</button>
